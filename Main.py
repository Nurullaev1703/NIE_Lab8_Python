        ...
        if validation_of_data(self.tableWidget):
            ...
            while i < self.tableWidget.rowCount():
                ...
                try:
                    ...
                    multiplication_of_k_i_plus_factorial= (math.sqrt(
                        multiplication_of_k_i) + fact/2)

                    answer = (multiplication_of_k_i_plus_factorial)/(multiplication_of_k_i-sum_of_k_i)
                    print(item)
                    self.tableWidget.setItem(i, j,
                                             QTableWidgetItem(str(format(answer, ".4f"))))
